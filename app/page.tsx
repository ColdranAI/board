            ...
            <div className="grid gap-12 lg:grid-cols-2 lg:items-start lg:gap-16 xl:gap-24">
              <div className="flex flex-col justify-center space-y-6 lg:mt-14">
                <div className="flex items-center gap-3">
                  <Image src="/logo/Coldboard.svg" alt="Coldboard" width={50} height={50} />
                  <span className="text-4xl font-bold">Coldboard</span>
                  <BetaBadge />
                </div>
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-slate-600 md:text-xl dark:text-zinc-300">
                    Coldboard is the free, real-time sticky note board that helps your team stay
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-slate-600 text-lg max-w-2xl mx-auto dark:text-zinc-300">
                Coldboard brings your team together with powerful collaboration tools designed for
                modern workflows.
              </p>
            </div>
