  ...
  return (
    <div className={cn("relative", className)} ref={dropdownRef}>
      <Button
        ...
        disabled={disabled}
        className={cn(
          "flex items-center space-x-2 px-3 py-2 text-sm border border-neutral-200 dark:border-zinc-800 rounded-md bg-card dark:bg-zinc-900 hover:bg-accent dark:hover:bg-zinc-800 focus:outline-none focus:ring-2 focus:ring-neutral-500 dark:focus:ring-zinc-600 focus:border-transparent transition-colors",
      ...
      {isOpen && (
        <div className="fixed sm:absolute left-0 w-full sm:w-80 mt-2 bg-white dark:bg-zinc-900 rounded-md shadow-lg border border-neutral-200 dark:border-zinc-800 z-50 p-4">
